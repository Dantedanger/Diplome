...
class SyllibusDiscipline(QDialog):
    def __init__(self, parent=None):
        ...
        loader = QUiLoader()
        ui_file_path_update = "syllibusdisciplineupdate.ui"
    ...
    def populate_combobox(self,x:QWidget):
        x.comboBox.clear()
        self.ui_update.lineEdit.setText("")
        cursor = self.mydb.cursor()
        ...
        if (x==self.ui_update):
            ...
            if (selectedItems):
                ...
                self.ui_update.lineEdit.setText(selectedItems[2].text())
        cursor.close()
    ...
    def updateDatabase(self):
        ...
        if selectedItems:
            ...
            semester = self.ui_update.lineEdit.text()
